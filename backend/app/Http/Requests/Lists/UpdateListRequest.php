...
class UpdateListRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', 'required', 'string', 'in:static,dynamic'],
            'rule' => ['sometimes', 'nullable', 'array', 'required_if:type,dynamic', 'min:1'],
            ...
            'contacts' => ['sometimes', 'nullable', 'array', 'required_if:type,static'],
